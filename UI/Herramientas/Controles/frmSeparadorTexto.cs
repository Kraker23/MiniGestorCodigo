...
{
    public partial class frmSeparadorTexto : Form
    {
        public partesPrograma partes;

        public frmSeparadorTexto()
        {
            InitializeComponent();
        }

        public frmSeparadorTexto(partesPrograma partes)
            : this()
        {
            this.partes = partes;
        ...
        private void frmSeparadorTexto_Load(object sender, EventArgs e)
        {
